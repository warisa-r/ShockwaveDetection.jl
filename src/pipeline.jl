...
struct ShockDetectionResult2D
    ...
    angle_estimated_over_time::Vector{Any}
...
function detect(flow_data::FlowData, shock_point_algo::Abstract2DShockDetectionAlgo, cluster_algo::DBSCANAlgo)
    shock_positions_over_time, angle_estimated_over_time = detect_shock_points(flow_data, shock_point_algo)
    ...
    return ShockDetectionResult2D(shock_positions_over_time, angle_estimated_over_time, shock_clusters_over_time, shock_fits_over_time)
end